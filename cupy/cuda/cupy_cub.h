...
void cub_device_segmented_sort(void*, size_t&, void*, void*, int, int, void*, cudaStream_t, int);
...
size_t cub_device_segmented_sort_get_workspace_size(void*, void*, int, int, void*, cudaStream_t, int);
