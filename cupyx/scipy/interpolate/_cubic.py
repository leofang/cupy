...
def _prepare_input(x, y, axis, dydx=None):
    ...
    y = cupy.rollaxis(y, axis)
    if dydx is not None:
        dydx = cupy.rollaxis(dydx, axis)
...
class PchipInterpolator(CubicHermiteSpline):
    ...
    def __init__(self, x, y, axis=0, extrapolate=None):
        x, _, y, axis, _ = _prepare_input(x, y, axis)
    ...
    def _edge_case(h0, h1, m0, m1):
        ...
        mask2 = (cupy.sign(m0) != cupy.sign(m1)) & (cupy.abs(d) > 3.*cupy.abs(m0))
        mmm = (~mask) & mask2
...
# TODO(leofang): Add Akima1DInterpolator


# TODO(leofang): Add CubicSpline
